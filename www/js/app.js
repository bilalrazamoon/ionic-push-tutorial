...
angular.module('starter', ['ionic', 'starter.controllers', 'ionic.service.core', 'ionic.service.push'])
  ...
  .config(['$ionicAppProvider', function ($ionicAppProvider) {
    ...
    $ionicAppProvider.identify({
      ...
      //true for fake push, false for real push
      dev_push: false,
      // Your GCM sender ID/project number (Uncomment if supporting Android)
      gcm_id: 'PROJECT_NUMBER'
    });

  }])

  .run(['$ionicPlatform', '$rootScope', '$ionicPush', '$cordovaPush', function ($ionicPlatform, $rootScope, $ionicPush, $cordovaPush) {
